...
if __name__ == "__main__":
    ...
    seq_pattern_query = ProcessingUtilities.CleanPatternQuery(seq_event_pattern, [condition], 16, use_const_window=True)
    and_event_pattern = ProcessingUtilities.EventPattern(stock_types_with_identifiers, ProcessingUtilities.And())
    and_pattern_query = ProcessingUtilities.CleanPatternQuery(and_event_pattern, [condition], 16, use_const_window=True)
